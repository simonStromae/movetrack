...
<!-- Content Header (Page header) -->
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Ajouter un Pays</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    ...
                    <div class="row ">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" wire:model.lazy="slug"  class="form-control @error('slug') is-invalid @enderror" id="exampleInputEmail1" placeholder="Abréviation du pays" value="{{old('slug')}}">
                                @error('slug')
                                <div class="">
                                    <p class="text-sm text-danger">{{$message}}</p>
                                </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" wire:model.lazy="code"  class="form-control @error('code') is-invalid @enderror" id="exampleInputEmail1" placeholder="Code téléphonique du pays" value="{{old('code')}}">
