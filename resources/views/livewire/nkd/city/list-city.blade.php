    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <div class="card-header">
                <h3 class="card-title font-weight-bold">Liste des Villes</h3>
                <a href="{{ route('backend.city.create') }}" class="float-right btn btn-primary btn-sm ml-1"><i class="fas fa-plus-circle mr-1"></i>Ajouter une ville</a>
            </div>
            <!-- /.card-header -->
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        @forelse($cities as $c)
                            <tr >
                                ...
                                <td>
                                    <a class="btn btn-outline-primary btn-xs" href="{{route('backend.city.edit',$c->id)}}"><i class="fas fa-user-edit"></i></a>
                                    ...
                                    @include('layouts.partials.delete_modal',
                                       [
                                           'id'=> $c->id,
                                           'name'=> 'Ville',
                                           "route"=> route('backend.city.destroy', $c->id),
                                           "sms"=> "Vouler-vous supprimer définitivement la ville : $c->name?"
                                       ])
                                </td>
                            </tr>
                ...
                @else
                    <div class="error-content text-center">
                        ...
                        <p>
                            ...
                            Ajouter une ville en cliquant ici <i class="ml-2 mr-2 fas fa-arrow-right"></i> <a href="{{ route('backend.city.create') }}">ajouter une ville</a>.
                        </p>
                    </div>
                @endif
